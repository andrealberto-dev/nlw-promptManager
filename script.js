...
// Adiciona os handlers de input para atualização em tempo real
...
function save() {
  ...
  if (!title || !hasContent) {
    alert("Título e conteúdo não pode estar vazios.");
    return;
  }
...
function createPromptItem(prompt) {
  ...
  // usar o conteúdo salvo do prompt para gerar a descrição em texto
...
function init() {
  ...
  // Handler para abrir a sidebar
  elements.btnOpen.addEventListener("click", () => {
    elements.sidebar.style.display = "flex";
    elements.btnOpen.style.display = "none";
  });

  // Handler para fechar a sidebar
